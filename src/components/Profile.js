        ...
        <div className="row">
          ...
          <div className="col-xl-4 profileProfCont">
            <div className="profileProf">
              ...
              <div className="profileBtn"><a className="profileCV" target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1DdubIdptvrtwGk96ziQGUD50pIWaM8Pa/view?usp=sharing">Download CV</a></div>
            </div>
          </div>
        </div>
      </div>
